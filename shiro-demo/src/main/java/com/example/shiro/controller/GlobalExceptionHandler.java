...
import com.example.shiro.constant.Codes;
import com.example.shiro.vo.Json;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public Json handleException(Exception e) {
        String eName = e.getClass().getSimpleName();
        log.error("handleException：{}", eName);
        return new Json(eName, false, Codes.SHIRO_ERR, e.getMessage(), null);
    }
